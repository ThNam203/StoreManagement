...
export default function DiscountPage() {
  ...
  const NewDiscountButton = () => {
    ...
    const onSubmit = (values: z.infer<typeof newDiscountFormSchema>) => {
      ...
      const data: UploadDiscountDataType = {
        ...
        startDate: format(values.time.startDate, "yyyy-MM-dd hh:mm:ss"),
        endDate: format(values.time.endDate, "yyyy-MM-dd hh:mm:ss"),
      };
          ...
          <div className="fixed top-0 left-0 w-screen h-screen bg-transparent backdrop-blur-sm flex items-center justify-center z-10">
            ...
            >
              ...
              >
                ...
                <FormContent
                  onSubmit={onSubmit}
                  isCreatingNewDiscount={isCreatingNewDiscount}
                  setOpen={setOpen}
                />
              </div>
            </div>
  ...
  return (
    ...
    >
      <CatalogDatatable data={discounts} />
    </PageWithFilters>
  );
}
      ...
      >
                  ...
                  <FormItem className="flex-1 flex flex-row mb-2">
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        />
                        {form.getValues("type") === "COUPON" ? <p>%</p> : null}
                      </div>
                    </FormControl>
                  </FormItem>
                )}
                    ...
                    return (
                      <FormItem className="flex flex-row mb-2">
                        <FormLabel className="flex flex-col text-black justify-center">
                          <p className="whitespace-nowrap mx-2">Max value</p>
                          <FormMessage className="mr-2 text-xs" />
                        </FormLabel>
                        <FormControl>
                          <Input
                ...
                <FormItem className="flex flex-row mb-2">
                  ...
                  <FormControl>
                    <Input
                      ...
                      value={field.value}
                      onChange={(e) =>
                        form.setValue("amount", e.currentTarget.valueAsNumber)
                      }
                    />
                  </FormControl>
                </FormItem>
                  ...
                  <FormControl>
                    <SearchAndChooseMultiple
                      value={products
                        .filter(
                          (product) =>
                            field.value && field.value.includes(product.id)
                        )
                        .map(
                          (product) =>
                            product.name +
                      ...
                      choices={products.map(
                        (p) =>
                          p.name +
                          (p.propertiesString ? ` (${p.propertiesString})` : "")
                      )}
                      onValueChanged={(val) =>
                        form.setValue(
                          "products",
                ...
                <FormItem className="flex flex-row mb-2">
                  ...
                  <FormControl>
                    <>
                      ...
                      >
                        <p>
                          {format(field.value.startDate, "yyyy-MM-dd, hh:mm")} -{" "}
                          {format(field.value.endDate, "yyyy-MM-dd, hh:mm")}
                        </p>
        ...
        <div className="flex flex-row gap-8">
          ...
          >
            Save
            <LoadingCircle
              className={"!w-4 ml-4 " + (isCreatingNewDiscount ? "" : "hidden")}
            />
          </Button>
          <Button
            variant={"green"}
