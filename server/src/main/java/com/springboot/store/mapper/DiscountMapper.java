...
public class DiscountMapper {
    public static DiscountDTO toDiscountDTO(Discount discount) {
        return DiscountDTO.builder()
                ...
                .maxTotal(discount.getMaxTotal())
                .minTotal(discount.getMinTotal())
                ...
                .discountCodes(discount.getDiscountCodes() == null ? null :
                        discount.getDiscountCodes().stream().map(DiscountCode::getCode).collect(Collectors.toSet()))
    ...
    public static Discount toDiscount(DiscountDTO discountDTO) {
        return Discount.builder()
                ...
                .maxTotal(discountDTO.getMaxTotal())
                .minTotal(discountDTO.getMinTotal())
