    ...
    return (
      <input
        ...
        className={cn(
          ...
          props.showBorderOnFocus === undefined || props.showBorderOnFocus ? "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2" : "focus-visible:ring-0 focus-visible:ring-ring focus-visible:ring-offset-0",
          className
        )}
        ref={ref}
        {...props}
